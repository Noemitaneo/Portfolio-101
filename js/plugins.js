...
(function (d, c, a, f) {
  ...
  b.prototype.slide = function (m, o, j) {
    ...
    if (!l.lgBusy) {
      if (this.s.download) {
        ...
        if (l.s.dynamic) {
          i =
            l.s.dynamicEl[m].downloadUrl !== false &&
            (l.s.dynamicEl[m].downloadUrl || l.s.dynamicEl[m].src);
        } else {
          i =
            l.$items.eq(m).attr("data-download-url") !== "false" &&
            (l.$items.eq(m).attr("data-download-url") ||
              l.$items.eq(m).attr("href") ||
              l.$items.eq(m).attr("data-src"));
        }
        if (i) {
  ...
  b.prototype.setTranslate = function (h, i, g) {
    if (this.s.useLeft) {
      ...
      h.css({ transform: "translate3d(" + i + "px, " + g + "px, 0px)" });
    }
  };
    ...
    if (k.s.enableDrag && !k.isTouch && k.doCss()) {
      k.$slide.on("mousedown.lg", function (l) {
        if (!k.$outer.hasClass("lg-zoomed")) {
          if (
            d(l.target).hasClass("lg-object") ||
            d(l.target).hasClass("lg-video-play")
          ) {
            l.preventDefault();
            if (!k.lgBusy) {
              k.manageSwipeClass();
  ...
  b.prototype.closeGallery = function () {
    ...
    if (h.s.closable) {
      h.$outer.on("mousedown.lg", function (i) {
        if (
          d(i.target).is(".lg-outer") ||
          d(i.target).is(".lg-item ") ||
          d(i.target).is(".lg-img-wrap")
        ) {
          g = true;
        } else {
          g = false;
...
(function (d, c, a, f) {
  var e = { scale: 1, zoom: true, enableZoomAfter: 300 };
  var b = function (g) {
  ...
  b.prototype.init = function () {
    ...
    var k = function (s) {
      ...
      var n = (s - 1) * q;
      var t = (s - 1) * p;
      r.css("transform", "scale3d(" + s + ", " + s + ", 1)").attr(
        "data-scale",
        s
      );
      r.parent()
        .css("transform", "translate3d(-" + n + "px, -" + t + "px, 0)")
        .attr("data-x", n)
        .attr("data-y", t);
    };
    var g = function () {
  ...
  b.prototype.zoomSwipe = function () {
    ...
    l.core.$slide.on("touchstart.lg", function (n) {
      if (l.core.$outer.hasClass("lg-zoomed")) {
        ...
        k =
          m.outerHeight() * m.attr("data-scale") >
          l.core.$outer.find(".lg").height();
        g =
          m.outerWidth() * m.attr("data-scale") >
          l.core.$outer.find(".lg").width();
        if (g || k) {
          n.preventDefault();
          j = {
  ...
  b.prototype.zoomDrag = function () {
    ...
    m.core.$slide.on("mousedown.lg.zoom", function (o) {
      ...
      l =
        n.outerHeight() * n.attr("data-scale") >
        m.core.$outer.find(".lg").height();
      g =
        n.outerWidth() * n.attr("data-scale") >
        m.core.$outer.find(".lg").width();
      if (m.core.$outer.hasClass("lg-zoomed")) {
        if (d(o.target).hasClass("lg-object") && (g || l)) {
          o.preventDefault();
          k = { x: o.pageX, y: o.pageY };
          h = true;
  ...
  b.prototype.touchendZoom = function (q, j, k, i) {
    ...
    var g = Math.abs(
      n.outerHeight() * Math.abs(n.attr("data-scale")) -
        p.core.$outer.find(".lg").height() +
        m
    );
    var o = (p.core.$outer.find(".lg").width() - n.outerWidth()) / 2;
    var h = Math.abs(
      n.outerWidth() * Math.abs(n.attr("data-scale")) -
        p.core.$outer.find(".lg").width() +
        o
    );
    if (i) {
      if (r <= -g) {
...
(function (i, l, n, g) {
      ...
      run: function () {
        var q,
          ...
          s = this.settings.loop
            ? r.length - Math.max(this.settings.items * 2, 4)
            : 0;
      ...
      run: function () {
        ...
        if (
          ...
          for (q = 0, s = this._coordinates.length; q < s; q++) {
            e.width =
              Math.abs(this._coordinates[q]) -
              Math.abs(this._coordinates[q - 1] || 0) -
              this.settings.margin;
    ...
    },
    {
      ...
      run: function () {
        ...
        for (s = 0, e = this._coordinates.length; s < e; s++) {
          ...
          if (
            (this.op(x, "<=", q) && this.op(x, ">", r)) ||
            (this.op(w, "<", q) && this.op(w, ">", r))
          ) {
            t.push(s);
          }
        }
  ...
  c.prototype.initialize = function () {
    ...
    if (this.settings.autoWidth && this.state.imagesLoaded !== true) {
      ...
      q = this.settings.nestedItemSelector
  ...
  c.prototype.coordinates = function (e) {
    ...
    if (this.settings.center) {
      ...
      q +=
        ((this.width() - q + (this._coordinates[e - 1] || 0)) / 2) *
  ...
  c.prototype.duration = function (r, q, e) {
    return (
      Math.min(Math.max(Math.abs(q - r), 1), 6) *
  ...
  c.prototype.replace = function (e) {
    ...
    e.filter(function () {
      ...
      i.proxy(function (q, r) {
        ...
        this._items.push(r);
        this._mergers.push(
          r.find("[data-merge]").addBack("[data-merge]").attr("data-merge") *
            1 || 1
        );
      }, this)
    );
    this.reset(
      i.isNumeric(this.settings.startPosition) ? this.settings.startPosition : 0
    );
  ...
  c.prototype.add = function (q, e) {
    ...
    if (this._items.length === 0 || e === this._items.length) {
      ...
      this._items.push(q);
      this._mergers.push(
        q.find("[data-merge]").addBack("[data-merge]").attr("data-merge") * 1 ||
          1
      );
    } else {
  ...
  c.prototype.trigger = function (q, u, s) {
    var e = { item: { count: this._items.length, index: this.current() } },
      ...
      t = i.Event(
        [q, "owl", s || "carousel"].join(".").toLowerCase(),
        i.extend({ relatedTarget: this }, e, u)
      );
    if (!this._supress[q]) {
    ...
    this._handlers = {
      ...
      "loaded.owl.lazy": c.proxy(function (g) {
        if (
          ...
          g.element.closest("." + this._core.settings.itemClass) ===
...
(function (d, b, a, e) {
  ...
  c.prototype.initialize = function () {
    ...
    if (!f.dotsData) {
      this._templates = [
        d("<div>").addClass(f.dotClass).append(d("<span>")).prop("outerHTML"),
      ];
    }
    if (!f.navContainer || !f.dotsContainer) {
      this._controls.$container = d("<div>")
        .addClass(f.controlsClass)
    ...
    this._controls.$indicators.on(
      ...
      "div",
      d.proxy(function (j) {
        var i = d(j.target).parent().is(this._controls.$indicators)
          ? d(j.target).index()
          : d(j.target).parent().index();
        j.preventDefault();
  ...
  c.prototype.onTrigger = function (g) {
    ...
    g.page = {
      ...
      size:
        f && (f.center || f.autoWidth || f.dotData ? 1 : f.dotsEach || f.items),
    };
  };
...
(function (e, t, r) {
  ...
  function n(r) {
    ...
    (Tt = r.edgeStrategy || "set"),
      ...
      Kt
        ? ((ct = t.getElementById(r.skrollrBody || E)),
          ct && it(),
          j(),
          Dt(o, [y, S], [T]))
        : Dt(o, [y, b], [T]),
  ...
  (n.prototype.refresh = function (e) {
    ...
    for (
      e === r
        ? ((a = !0), (st = []), (Gt = 0), (e = t.getElementsByTagName("*")))
        : e.length === r && (e = [e]),
        n = 0,
        o = e.length;
      o > n;
      ...
      if ((a && I in i && delete i[I], i.attributes)) {
        ...
        if (s.length) {
          ...
          !a && I in i
            ...
            : ((x = i[I] = Gt++), (k = i.style.cssText), (w = Ht(i))),
            (st[x] = {
              element: i,
              styleAttr: k,
              classAttr: w,
        ...
        switch (
          ...
          case p:
            ...
            C > Vt
              ...
              : 0 > C && ((H = -C / F), (C = 0)),
              (A *= 1 - H),
              lt.animateTo(0 | (C + 0.5), { easing: "outCubic", duration: A });
        }
      }),
        e.scrollTo(0, 0),
        ...
        for (
          ...
          (l = n[a]),
            ...
            "relative" === l.mode &&
              (at(t),
              (l.frame =
                lt.relativeToAbsolute(r, l.anchors[0], l.anchors[1]) - u),
              at(t, !0)),
            (l.frame += m),
      ...
      for (var r = 0, n = st.length; n > r; r++) {
          ...
          switch (
            (T
              ? (Dt(c, [g], [h, v]),
                k &&
                  w > -1 &&
                  (Et(c, p.eventType, qt), (s.lastFrameIndex = -1)))
              : (Dt(c, [h], [g, v]),
                k && m > w && (Et(c, y.eventType, qt), (s.lastFrameIndex = m))),
            (s.edge = T ? -1 : 1),
            s.edgeStrategy)
          ) {
            case "reset":
        ...
        for (var E = 0; m - 1 > E; E++)
          if (f >= u[E].frame && u[E + 1].frame >= f) {
            ...
            k &&
              w !== E &&
              ("down" === qt ? Et(c, A.eventType, qt) : Et(c, F.eventType, qt),
              (s.lastFrameIndex = E));
            break;
          }
      }
    ...
    J = function () {
      ...
      if (dt)
        o >= dt.endTime
          ...
          : ((t = dt.easing((o - dt.startTime) / dt.duration)),
        ...
        a &&
          ...
          ht.endTime >= o &&
            ((t = X.sqrt((o - ht.startTime) / vt)),
            (n = 0 | (ht.startTop + t * ht.topDiff)));
      }
      if (
        (Kt &&
          ct &&
          i.setStyle(ct, "transform", "translate(0, " + -Yt + "px) " + bt),
        yt || Lt !== n)
      ) {
  ...
  var lt,
    ...
    kt = (i.addEvent = function (t, r, n) {
      ...
      for (var a, i = 0, l = r.length; l > i; i++)
        (a = r[i]),
          ...
          Rt.push({ element: t, name: a, listener: n });
    }),
    ...
    Ct = function () {
      var e,
        t = 0;
      return (
        ct && (t = s.max(ct.offsetHeight, ct.scrollHeight)),
        (e = s.max(
          t,
          a.scrollHeight,
          a.offsetHeight,
...
(function (g, i, k) {
  var e = function e(q) {
      var o = k.createElement("script"),
        p = k.getElementsByTagName("head")[0];
  ...
  YTPlayer = {
    ...
    init: function n(p, q) {
      ...
      o.$window.on("resize.YTplayer" + o.ID, function () {
        o.resize(o);
      });
  ...
  function a(f, e) {
    var i = c(f),
      ...
      j = {
        ...
        position: { x: f.width * 1, y: f.height * 0.5 },
        width: b.innerWidth,
    ...
    function g() {
      ...
      this.vx = d.velocity - Math.random() * 0.5;
      this.vy = d.velocity - Math.random() * 0.5;
      this.radius = Math.random() * d.star.width;
    }
    g.prototype = {
      create: function () {
        h.beginPath();
        h.arc(this.x, this.y, this.radius, 0, Math.PI * 2, false);
        h.fill();
      },
      animate: function () {
        var k;
        for (k = 0; k < d.length; k++) {
          var l = d.stars[k];
          if (l.y < 0 || l.y > f.height) {
            l.vx = l.vx;
            l.vy = -l.vy;
          } else {
            if (l.x < 0 || l.x > f.width) {
              l.vx = -l.vx;
              l.vy = l.vy;
            }
          }
        ...
        for (m = 0; m < n; m++) {
          for (l = 0; l < n; l++) {
            ...
            if (
              ...
              if (
                o.x - d.position.x < d.radius &&
                o.y - d.position.y < d.radius &&
                o.x - d.position.x > -d.radius &&
                o.y - d.position.y > -d.radius
              ) {
                h.beginPath();
    ...
    this.setCanvas = function () {
      f.width = c(".particular").width();
      f.height = d.height;
    };
    this.setContext = function () {
      h.fillStyle = d.star.color;
      h.strokeStyle = d.line.color;
      h.lineWidth = d.line.width;
    };
    ...
    this.bind = function () {
      c(b).on("mousemove", function (k) {
        d.position.x = k.pageX - i.offset().left;
        d.position.y = k.pageY - i.offset().top;
      });
    };
    this.init = function () {
      this.setCanvas();
  ...
  b.prototype.init = function () {
    ...
    h.core.$el.on("hasVideo.lg.tm", function (k, i, m, j) {
      h.core.$slide
        .eq(i)
        .find(".lg-video")
        .append(h.loadVideo(m, "lg-object", true, i, j));
      if (j) {
        if (h.core.s.videojs) {
          try {
            videojs(
              h.core.$slide.eq(i).find(".lg-html5").get(0),
              {},
              function () {
                if (!h.videoLoaded) {
                  this.play();
    ...
    h.core.$el.on("onAferAppendSlide.lg.tm", function (j, i) {
      h.core.$slide
        .eq(i)
        .find(".lg-video-cont")
        .css("max-width", h.core.s.videoMaxWidth);
      h.videoLoaded = true;
    });
    var g = function (r) {
      if (
        r.find(".lg-object").hasClass("lg-has-poster") &&
        r.find(".lg-object").is(":visible")
      ) {
        if (!r.hasClass("lg-has-video")) {
          ...
          var l;
          var q = function (u, s) {
            r.find(".lg-video").append(
              h.loadVideo(u, "", false, h.core.index, s)
            );
            if (s) {
              if (h.core.s.videojs) {
                try {
                  videojs(
                    h.core.$slide.eq(h.core.index).find(".lg-html5").get(0),
                    {},
                    function () {
                      this.play();
                    }
          ...
          if (h.core.s.dynamic) {
            ...
            m =
              h.core.$items.eq(h.core.index).attr("href") ||
              h.core.$items.eq(h.core.index).attr("data-src");
    ...
    if (
      h.core.doCss() &&
      h.core.$items.length > 1 &&
      ((h.core.s.enableSwipe && h.core.isTouch) ||
        (h.core.s.enableDrag && !h.core.isTouch))
    ) {
    ...
    h.core.$el.on("onBeforeSlide.lg.tm", function (j, n, p) {
      ...
      if (h.core.s.dynamic) {
        ...
        m =
          h.core.$items.eq(p).attr("href") ||
          h.core.$items.eq(p).attr("data-src");
      }
...
(function () {
  ...
  function af() {
    ...
    if (top != self) {
      ...
      if (X && at > au && (e.offsetHeight <= au || ar.offsetHeight <= au)) {
        ...
        setTimeout(t, 10);
        k("resize", t);
        var aq = { attributes: true, childList: true, characterData: false };
        R = new L(t);
        R.observe(e, aq);
  ...
  function u(ap) {
    ...
    if (!ao) {
      if (C && ah) {
        Object.defineProperty(ap, "target", { value: window.frameElement });
